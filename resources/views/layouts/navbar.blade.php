<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
            <a class="nav-link" href="{{route('danhmuc.create')}}">Danh mục</a>
          </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('phims.create')}}">Phim</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('tapphim.create')}}">Tập phim</a>
          </li>
