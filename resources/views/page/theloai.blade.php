...
<div class="row container" id="wrapper">
    {{-- <div class="halim-panel-filter">
       <div class="panel-heading">
          <div class="row">
             <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{$theloai_slug->title}}</a> » <span class="breadcrumb_last" aria-current="page">2020</span></span></span></div>
             </div>
          </div>
       </div>
               ...
               <div class="halim-item">
                  <a class="halim-thumb" href="{{route('phim', $mv->slug)}}" title="VŨNG LẦY PHẦN 1">
                     ...
                     <span class="status">
                        ...
                        @if ($mv -> phude==0)
                            Vietsub - {{$mv->sotap}} tập
                        @else
                            Thuyết minh - {{$mv->sotap}} tập
                        @endif
                    </span>
